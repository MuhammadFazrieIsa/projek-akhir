 ...
 <div class="style"> 
  ...
  <div class="container-fluid h-100">
    <div class="row h-100">
      ...
      <!-- Sidebar -->
<div id="sidebar" class="sidebar sidebar-expanded bg-success text-white d-flex flex-column align-items-start py-4 px-2">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6">
            <div class="bg-white rounded shadow-sm p-4 mb-4">
              ...
              <button class="btn btn-success mt-2">Add More Spots</button>
            </div>
